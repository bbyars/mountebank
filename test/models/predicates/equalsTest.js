...
describe('predicates', () => {
    describe('#equals', () => {
        ...
        it('should match missing field with empty string', () => {
        ...
        it('should obey be case-insensitive except match by default', () => {
            const predicate = { equals: { field: 'is is a test' }, except: '^tH' },
                request = { field: 'This is a test' };
            assert.ok(predicates.evaluate(predicate, request));
        });

        it('should be case-sensitive except match if configured', () => {
            const predicate = { equals: { field: 'his is a test' }, except: '^t', caseSensitive: true },
                request = { field: 'This is a test' };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should return true if any value in a multi-value key is equal', () => {
            const predicate = { equals: { query: { key: '234' } } },
                request = { query: { key: ['123', '234'] } };
            assert.ok(predicates.evaluate(predicate, request));
        });

        it('should return false if no value in a multi-value key is equal', () => {
