...
describe('predicates', () => {
    describe('#deepEquals', () => {
        it('should return false for mismatched strings', () => {
        ...
        it('should be true if empty object matches empty request field', () => {
            const predicate = { deepEquals: { query: {} } },
                request = { query: {} };
            assert.ok(predicates.evaluate(predicate, request));
        });

        it('should be false if empty object provided but request field not empty', () => {
            const predicate = { deepEquals: { query: {} } },
                request = { query: { q: 'test' } };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should match exact key-value pairs for objects', () => {
            const predicate = { deepEquals: { headers: { key: 'value' } } },
                request = { headers: { key: 'value' } };
            assert.ok(predicates.evaluate(predicate, request));
        });

        it('should not match if extra key exists in request field', () => {
            const predicate = { deepEquals: { headers: { key: 'value' } } },
                request = { headers: { key: 'value', other: 'other' } };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should match ignoring unspecified request fields', () => {
        ...
        it('should return false if mismatched key for object', () => {
            const predicate = { deepEquals: { headers: { key: 'value' } } },
        ...
        it('should allow matching values in a case sensitive fashion for objects', () => {
            const predicate = { deepEquals: { headers: { key: 'VALUE' } }, caseSensitive: true },
                request = { headers: { key: 'Value' } };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should match keys in a case insensitive fashion for object', () => {
            const predicate = { deepEquals: { headers: { KEY: 'value' } } },
                request = { headers: { Key: 'value' } };
            assert.ok(predicates.evaluate(predicate, request));
        });

        it('should allow matching keys in a case sensitive fashion for object', () => {
            const predicate = { deepEquals: { headers: { KEY: 'value' } }, caseSensitive: true },
                request = { headers: { Key: 'value' } };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should be false if request has extra field', () => {
            const predicate = { deepEquals: { headers: { key: 'value' } }, caseSensitive: true },
                request = { headers: { key: 'value', other: 'next' } };
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should not match missing field with empty string', () => {
            const predicate = { deepEquals: { field: '' } },
                request = {};
            assert.ok(!predicates.evaluate(predicate, request));
        });

        it('should return true if equals binary sequence and encoding is base64', () => {
        ...
        it('should return false if is not binary sequence and encoding is base64', () => {
        ...
        it('should be true if equal with null object value', () => {
