...
module.exports = function (grunt) {
    ...
    grunt.registerTask('test:zip:x64', 'Run tests against packaged zipfile',
        ['download:zip:x64', 'install:zip:x64', 'test', 'lint']);
    grunt.registerTask('test:zip:x86', 'Run tests against packaged zipfile',
        ['download:zip:x86', 'install:zip:x86', 'test', 'lint']);
